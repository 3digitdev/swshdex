...
{
	if (region.ae.L === region.al.L)
	{
		return 'on line ' + region.ae.L;
	}
	return 'on lines ' + region.ae.L + ' through ' + region.al.L;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {an: fragment, aq: host, av: path, ax: port_, aA: protocol, aC: query};
	});
...
var $author$project$Pokemon$initDefenses = {Y: _List_Nil, aB: _List_Nil, ag: _List_Nil, X: _List_Nil, aQ: _List_Nil};
...
var $author$project$Pokemon$Pokemon = F5(
	function (name, number, pokeType, armorNum, exclusive) {
		return {ai: armorNum, aZ: exclusive, a: name, at: number, k: pokeType};
	});
							...
							if (_v0.b.b) {
								if (!_v0.b.b.b) {
									...
									if ((!_v2.a.$) && (!_v2.b.$)) {
										...
										return $elm$json$Json$Decode$fail('Invalid Type in ' + (typeOne + (' ' + typeTwo)));
									}
								} else {
									break _v0$2;
								}
...
var $author$project$Pokemon$Type = F5(
	function (name, strengths, weaknesses, ineffectives, noEffects) {
		return {Z: ineffectives, a: name, aa: noEffects, W: strengths, bi: weaknesses};
	});
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{aT: false, aV: r.aV, a_: r.a_, ao: r.ao, a3: r.a3, bd: r.bd, aM: r.aM, bg: r.bg}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{aV: $elm$http$Http$emptyBody, a_: r.a_, ao: _List_Nil, a3: 'GET', bd: $elm$core$Maybe$Nothing, aM: $elm$core$Maybe$Nothing, bg: r.bg});
};
...
var $author$project$Main$suggestFirstPokemon = function (model) {
	var example = $elm$core$List$head(
		A2(
...
var $author$project$Pokemon$Defenses = F5(
	function (x4, x2, x0, half, quarter) {
		return {Y: half, aB: quarter, ag: x0, X: x2, aQ: x4};
	});
...
var $author$project$Main$calculateDualTypeStats = F2(
						...
						function (curType) {
							var noEffect = A2(
								...
								A3(
									$elm$core$Tuple$mapBoth,
									function (a) {
										return A2($elm$core$List$member, a, curType.aa);
									},
									function (a) {
										return A2($elm$core$List$member, a, curType.aa);
									},
			...
			case 5:
				...
				var results = function () {
					if (searchStr === '') {
						...
						return A2($author$project$Main$findMatchByName, searchStr, model.u);
					}
				}();
				return _Utils_Tuple2(
					_Utils_update(
				...
				var examplePokemonList = function () {
					...
					if (_v11.$ === 1) {
						...
						return ($elm$core$List$length(
							$author$project$Main$getExamplePokemon(model)) > 1) ? A2(
							$elm_community$list_extra$List$Extra$remove,
							pokemon,
							$author$project$Main$getExamplePokemon(model)) : $elm$core$List$singleton(pokemon);
					}
				}();
				return _Utils_Tuple2(
					model,
					A2(
						...
						$elm_community$random_extra$Random$List$choose(examplePokemonList)));
			default:
				var _v12 = msg.a;
				var pokemon = _v12.a;
				return _Utils_Tuple2(
					...
					A2(
						...
						function (curType) {
							return A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('type-link-no-indent btm-gap'),
										$elm$html$Html$Events$onClick(
...
var $author$project$Main$renderPokemon = function (pokemon) {
	var name = A2($elm$core$String$contains, 'Galarian', pokemon.a) ? A2(
		$elm$html$Html$strong,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('galar-name')
			]),
		_List_fromArray(
			[
				$elm$html$Html$text(
				A3($elm$core$String$replace, 'Galarian ', '', pokemon.a))
			])) : (A2($elm$core$String$contains, 'Alolan', pokemon.a) ? A2(
		$elm$html$Html$strong,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('alola-name')
			]),
		_List_fromArray(
			[
				$elm$html$Html$text(
				A3($elm$core$String$replace, 'Alolan ', '', pokemon.a))
			])) : A2(
		$elm$html$Html$strong,
		_List_Nil,
		_List_fromArray(
	...
	var galarDexNum = (pokemon.at === '') ? 'N/A: ' : (pokemon.at + ': ');
		...
		switch (_v0) {
						...
						[
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Attributes$src('shield.png')
								]),
							_List_Nil)
						]));
			case 'Sword':
			...
			default:
				return A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('no-exclusive')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('')
...
var $author$project$Main$renderOffenseInfoSet = F3(
	function (model, modifier, typeNameList) {
		return A3(
			$author$project$Main$renderIfNotEmptyTypeList,
			typeNameList,
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text(modifier + ' damage against:')
								])),
							$author$project$Main$renderBadgeList(types)
						]));
			},
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A3($author$project$Main$renderDefenseInfoSet, model, '4x', model.r.aQ),
				...
				A3($author$project$Main$renderDefenseInfoSet, model, '1/4', model.r.aB),
				A2(
				$elm$html$Html$h3,
				_List_Nil,
				_List_fromArray(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Example Pokemon')
					])),
				innerHtml
			]));
};
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						A3($author$project$Main$renderSingleInfoSet, model, 'Weak to:', singleType.bi),
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						$author$project$Main$renderExamplePokemon(model)
					]));
		} else {
